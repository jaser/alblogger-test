...
theText = theText.replace(/\[youtube\].*?'.*?\[\/youtube\]/gi, "");
                       theText = theText.replace(/\[img\]/gi, "<div style='clear:both'></div><img style='margin:5px auto;display:block;border:1px solid #DDD;max-width:95%;background:#FFF;padding:4px' src='");
